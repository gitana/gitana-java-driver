...
import org.gitana.platform.client.nodes.NodeImpl;
...
{
    public GroupImpl(Branch branch, ObjectNode obj, boolean isSaved)
    {
    ...
    {
        return getString(FIELD_PRINCIPAL_DOMAIN);
    }
    ...
    public DomainGroup getDomainGroup()
    {
        ...
        return (DomainGroup) domain.readPrincipal(getPrincipalId());
    }
}
