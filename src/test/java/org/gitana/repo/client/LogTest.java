...
public class LogTest extends AbstractTestCase
{
        ...
        throws Exception
    {
        ...
        ResultMap<LogEntry> serverLogs1 = server.queryLogEntries(JsonUtil.createObject());
        ...
        byte[] bytes = ClasspathUtil.bytesFromClasspath("org/gitana/repo/client/afterUpdateNodeLog.js");
        ...
        ResultMap<LogEntry> serverLogs2 = server.queryLogEntries(JsonUtil.createObject());
