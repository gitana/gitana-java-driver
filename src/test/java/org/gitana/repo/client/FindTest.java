...
public class FindTest extends AbstractTestCase
{
        ...
        throws Exception
    {
        ...
        earth.uploadAttachment(ClasspathUtil.bytesFromClasspath("org/gitana/repo/client/bio_earth.txt"), "text/plain");
        ...
        usa.uploadAttachment(ClasspathUtil.bytesFromClasspath("org/gitana/repo/client/bio_usa.txt"), "text/plain");
        ...
        bolivia.uploadAttachment(ClasspathUtil.bytesFromClasspath("org/gitana/repo/client/bio_bolivia.txt"), "text/plain");
        ...
        milwaukee.uploadAttachment(ClasspathUtil.bytesFromClasspath("org/gitana/repo/client/bio_milwaukee.txt"), "text/plain");
        ...
        boston.uploadAttachment(ClasspathUtil.bytesFromClasspath("org/gitana/repo/client/bio_boston.txt"), "text/plain");
        ...
        chicago.uploadAttachment(ClasspathUtil.bytesFromClasspath("org/gitana/repo/client/bio_chicago.txt"), "text/plain");
        ...
        lapaz.uploadAttachment(ClasspathUtil.bytesFromClasspath("org/gitana/repo/client/bio_lapaz.txt"), "text/plain");
