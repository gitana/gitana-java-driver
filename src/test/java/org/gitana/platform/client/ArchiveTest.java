...
public class ArchiveTest extends AbstractTestCase
{
        ...
        throws Exception
    {
        ...
        byte[] bytes2 = ClasspathUtil.bytesFromClasspath("org/gitana/platform/client/archive2.zip");
        ...
        byte[] bytes3 = ClasspathUtil.bytesFromClasspath("org/gitana/platform/client/archive3.zip");
        ...
        ResultMap<Archive> query4 = vault.queryArchives(QueryBuilder.start(Archive.FIELD_VERSION_ID).is("1.0.0").get());
