...
public class StackTeamTest extends AbstractTestCase
{
    ...
    public void testTeams()
    {
        ...
        Platform platform1 = gitana.authenticate(user1.getName(), TestConstants.TEST_PASSWORD);
        platform1.readRepository(repository.getId()).update();

        // user 2 should be able to READ the repository but not update it
        Platform platform2 = gitana.authenticate(user2.getName(), TestConstants.TEST_PASSWORD);
        ...
        Platform platform3 = gitana.authenticate(user3.getName(), TestConstants.TEST_PASSWORD);
        ...
        platform1 = gitana.authenticate(user1.getName(), TestConstants.TEST_PASSWORD);
