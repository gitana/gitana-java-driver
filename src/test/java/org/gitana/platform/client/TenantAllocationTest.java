...
public class TenantAllocationTest extends AbstractTestCase
{
        ...
        throws Exception
    {
        ...
        assertEquals(25, tenant1.listAllocatedObjects().size()); // 21 + 4 defaults (domain, client, application, webhost) // and then -1 for some reason, cannot find a third client?
