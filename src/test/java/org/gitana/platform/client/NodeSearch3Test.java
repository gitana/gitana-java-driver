...
/**
 * Tests out search and the "_fields" sub-object.
 *
 * @author uzi
 */
public class NodeSearch3Test extends AbstractTestCase
{
    @Test
        ...
        throws Exception
    {
        ...
        // search for the word "harry" using pagination
        Pagination pagination = new Pagination(3, 2);
        Map<String, BaseNode> results2 = master.searchNodes(searchObject, pagination);
