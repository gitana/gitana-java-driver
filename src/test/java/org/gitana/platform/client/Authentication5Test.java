...
import org.gitana.http.OAuth2State;
import org.gitana.http.OAuth2StatePersister;
...
/**
 * Tests out a custom OAuth2 state persister.
 *
 * @author uzi
 */
public class Authentication5Test extends AbstractTestCase
{
    @Test
    public void testUsernamePasswordAuthentication()
    {
        ...
        OAuth2StatePersister statePersister = new OAuth2StatePersister() {
            @Override
